			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand" href="${APP_PATH}/" style="font-size:32px;">尚筹网-创意产品众筹平台</a>
				</div>
              ...
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="javascript:;"><i class="glyphicon glyphicon-scale"></i> 会员中心</a></li>
                    <li><a href="${APP_PATH}/member/message.htm"><i class="glyphicon glyphicon-comment"></i> 消息</a></li>
                    <li class="divider"></li>
	...
	<div class="row clearfix">
		<div class="col-sm-3 col-md-3 column">
			...
			<div class="list-group">
				...
				<div class="list-group-item " style="cursor:pointer;" onclick="window.location.href='${APP_PATH}/member/mine.htm'">
