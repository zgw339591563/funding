 ...
 <div class="navbar-wrapper">
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand"  style="font-size:32px;">尚筹网-创意产品众筹平台</a>
				</div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <ol class="carousel-indicators">
          <c:forEach items="${APP_ADVERT_MAP}" var="advert" varStatus="status">
      ...
      <div class="carousel-inner" role="listbox">
          <c:forEach items="${APP_ADVERT_MAP}" var="item" varStatus="status">
	        <div class="item <c:if test="${status.index == 0}">active</c:if>" onclick="window.location.href='${item.value.url}'" style="cursor:pointer;">
	          <img src="${APP_PATH}/pics/adv/${item.value.iconpath}" title="${item.value.name}" alt="${item.value.name}">
	        </div>
          </c:forEach>
      </div>
