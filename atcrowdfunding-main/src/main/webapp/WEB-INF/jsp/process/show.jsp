  ...
  <body>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<ol class="breadcrumb">
				  ...
				  <li class="active">流程图片</li>
				</ol>
			<div class="panel panel-default">
              <div class="panel-heading">流程图片<div style="float:right;cursor:pointer;" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-question-sign"></i></div></div>
			  <div class="panel-body">
				  <img id="procDefImg" src="${APP_PATH}/script/layer/skin/default/loading-1.gif">
			  </div>
			</div>
        </div>
      </div>
	...
	<script src="${APP_PATH}/jquery/jquery.form.js"></script>
        <script type="text/javascript">
            ...
            $("#procDefImg").attr("src", "${APP_PATH}/process/loadImg.do?id=${param.id}");
        </script>
  </body>
</html>
